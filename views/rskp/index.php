            ...
            <div class="panel-body">
                ...
                <div class="card">
                    <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs">
                        ...
                        <li>
                            <a href="#btabs-alt-static-files">Dokumen Final</a>
                        </li>
                    </ul>
...
//                                    $kualitas_real = $row->skpt_real_kualitas > 0 ? lws_divide($row->skpt_real_kualitas, $row->jml) : 0;
                        ...
                        <div class="tab-pane" id="btabs-alt-static-files">
                            <?php if ($final_uploaded_files && !empty($final_uploaded_files)): ?>
                                <?php foreach ($final_uploaded_files as $uploaded_file): ?>
                                    <a class="btn btn-xs btn-app-teal-outline" target="_blank" rel="noopener noreferrer" href="<?php echo base_url('_assets/uploads') . '/' . $final_random_id . '/' . $uploaded_file; ?>"><?php echo $uploaded_file ?></a>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
